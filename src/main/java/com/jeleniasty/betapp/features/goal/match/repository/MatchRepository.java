...
public interface MatchRepository extends JpaRepository<Match, Long> {
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Match m SET m.homeTeamScore = :home_team_score,m.awayTeamScore = :away_team_score, m.endTime = :end_time WHERE m.id = :id")
    void setMatchResult(@Param("home_team_score") Integer homeTeamScore,
